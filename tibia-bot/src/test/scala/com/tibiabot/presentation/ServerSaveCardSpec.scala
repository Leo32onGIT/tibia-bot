...
class ServerSaveCardSpec extends AnyFunSuite with Matchers {
  ...
  private val boss = daily(ServerSaveCard.BossLabel, "<:archfoe:1024710113728155738>",
    "**[Ferumbras Mortal Shell](https://tibia.fandom.com/wiki/Ferumbras_Mortal_Shell)**",
    "https://www.tibiawiki.com.br/wiki/Special:Redirect/file/Ferumbras_Mortal_Shell.gif")
  private val creature = daily(ServerSaveCard.CreatureLabel, "<:levelup:1075222553624326164>",
    "**[Dragon Lord](https://tibia.fandom.com/wiki/Dragon_Lord)**",
    "https://www.tibiawiki.com.br/wiki/Special:Redirect/file/Dragon_Lord.gif")
  private val rashid = daily(ServerSaveCard.RashidLabel, "<:gold:1133502093039251486>",
    "**[Liberty Bay](https://tibia.fandom.com/wiki/Rashid)**",
    "https://www.tibiawiki.com.br/wiki/Special:Redirect/file/Rashid.gif")
  private val dream = daily(ServerSaveCard.dreamCourtsLabel("Antica"), "<a:dreamscar:1504728980010438717>",
    "**[Izcandar the Banished](https://tibia.fandom.com/wiki/Dream_Scar/Boss_of_the_Day)**",
    "https://www.tibiawiki.com.br/wiki/Special:Redirect/file/Izcandar_the_Banished.gif")
  private val drome = daily(ServerSaveCard.DromeLabel, "<:drome:1507620940278923294>", "<t:1790000000:R>",
