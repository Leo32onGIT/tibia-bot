...
object BotApp extends App with StrictLogging {
  ...
  actorSystem.scheduler.schedule(60.seconds, 2.minutes) {
    ...
    val startTime = LocalDateTime.of(LocalDate.now, LocalTime.of(0, 0, 0)).atZone(ZoneId.of("Australia/Brisbane")).toInstant
    val endTime = LocalDateTime.of(LocalDate.now, LocalTime.of(0, 30, 0)).atZone(ZoneId.of("Australia/Brisbane")).toInstant
