 ...
 *  four Galthen call sites (ButtonHandler, ModalHandler x2, GalthenCommands),
 *  so that is what is extracted here.
...
object GalthenEmbeds {
   ...
   *  Mirrors the repeated 4050-character truncation block from those call sites. */
